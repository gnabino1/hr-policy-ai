...
Every module in this app asks this file for a logger instead of setting up its owm. That way all logs 
(from document loading to the final answer) ended uup in one place, in one consistent format.
"""
